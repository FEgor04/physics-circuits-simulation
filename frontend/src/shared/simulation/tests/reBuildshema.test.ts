...
test("re build test", () => {
  const expectedComponents: ElectricalComponentWithID[] = [
    ...
    { _type: "wire", a: { x: 0, y: 5 }, b: { x: 4, y: 5 }, id: 28 },
    {
      _type: "resistor",
      a: { x: 4, y: 5 },
      b: { x: 5, y: 5 },
    ...
    { _type: "wire", a: { x: 0, y: 5 }, b: { x: 4, y: 7 }, id: 25 },
    {
      _type: "voltmeter",
      a: { x: 4, y: 7 },
      b: { x: 5, y: 7 },
    ...
    { _type: "wire", a: { x: 6, y: 5 }, b: { x: 8, y: 4 }, id: 5 },
    {
      _type: "resistor",
      a: { x: 8, y: 4 },
      b: { x: 8, y: 3 },
    ...
    { _type: "wire", a: { x: 6, y: 5 }, b: { x: 7, y: 4 }, id: 15 },
    {
      _type: "resistor",
      a: { x: 7, y: 4 },
      b: { x: 7, y: 3 },
  ...
  const actComp = simulator.rebuildShema(simulator.findBranches());
  expect(actComp).toStrictEqual(expectedComponents);
});
